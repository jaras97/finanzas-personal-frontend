...
| `transactionDisplay.ts` (desde 2026-08-28) | Helpers de presentación de transacciones (`typeColor`, `isCreditCardPurchase`, `getTxCurrency`, `getStatusLabel`, `categoryBadgeClasses`) compartidos entre `(app)/transactions/columns.tsx` y `AccountTransactionsModal.tsx`, para que ambas vistas de movimientos usen los mismos colores/badges. |
